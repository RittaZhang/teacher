...
var treeMenu = [
	{ level:1, name:"部门管理"},
	{ level:2, name:"部门列表", ico:"images/icon_default.gif",link:"department/Department_query.action"},
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"teacher/Teacher_teacherSearch.action"},
	{ level:1, name:"学历管理"},
	{ level:2, name:"学历列表", ico:"images/icon_default.gif",link:"education/Education_educationSearch.action"},
	{ level:1, name:"选择项管理"},
	{ level:2, name:"选择项列表", ico:"images/icon_default.gif",link:"selection/Selection_query.action"},
	{ level:1, name:"教师花名册", ico:"images/icon_default.gif",link:"teacher/Teacher_getTeacherInfo.action"},
	{ level:1, name:"上传文件", ico:"images/icon_default.gif",link:"upload/UpLoad_toUpload.action"},
	{ level:1, name:"考勤列表", ico:"images/icon_default.gif",link:"attendance/Attendance_attendanceSearch.action"}
	];
</script>
<style type="text/css">
* {
